...
class EvolutionMachine:
    def __init__(
        self, reproduce_fraction, cull_fraction, mutation_probability, mutation_range
    ):
    ...
    def reproduce_population(self, population, n_reproduce):
        ...
        for child in offspring:
            child = self.mutate_chromosome(
                child, self.mutation_probability, self.mutation_range
            )
